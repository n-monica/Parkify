...
public class BookingService {
    ...
    public List<Booking> getBookingsByOwner(Long ownerId) { return bookingRepository.findByOwnerId(ownerId); }
    public List<Booking> getBookingsByParking(Long parkingId) { return bookingRepository.findByParkingId(parkingId); }
